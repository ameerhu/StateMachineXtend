...
public class TTemplateFan {
  private String path = "src/generatedFiles/";
  ...
  public CharSequence genInterface(final Action[] actions) {
    ...
    _builder.append("package generatedFiles;");
    _builder.newLine();
    _builder.newLine();
      ...
      if ((Objects.equal(s.getZuper(), null) && (!s.isComplex()))) {
              ...
              for(final Action a : actions) {
                {
                  ...
                  boolean _tripleNotEquals_1 = (_outgoings_2 != null);
                      ...
                      for(final Transition o : _outgoings_3) {
                        {
                          ...
                          boolean _tripleNotEquals_2 = (_name_2 != _name_3);
        ...
        if ((s.isComplex() && Objects.equal(s.getZuper(), null))) {
          ...
          _builder.newLineIfNotEmpty();
          {
            ...
            boolean _tripleNotEquals_3 = (_outgoings_4 != null);
            if (_tripleNotEquals_3) {
              {
                ...
                for(final Transition st_1 : _outgoings_5) {
                  _builder.append("\t");
                  _builder.append("public void ");
                  String _name_6 = st_1.getAction().getName();
                  ...
                  _builder.append("\t");
                  _builder.append("wrapper.setState(new ");
                  String _name_7 = st_1.getTarget().getName();
                ...
                for(final Action a_1 : actions) {
                  {
                    ...
                    boolean _tripleNotEquals_4 = (_outgoings_6 != null);
                    if (_tripleNotEquals_4) {
                      {
                        Transition[] _outgoings_7 = s.getOutgoings();
                        for(final Transition o_1 : _outgoings_7) {
                          {
                            String _name_9 = o_1.getAction().getName();
                            String _name_10 = a_1.getName();
                            boolean _tripleNotEquals_5 = (_name_9 != _name_10);
          ...
          if ((s.isComplex() && (s.getZuper() != null))) {
            ...
            String _name_13 = s.getZuper().getName();
            _builder.append(_name_13);
            _builder.append("{");
            _builder.newLineIfNotEmpty();
            {
              Transition[] _outgoings_8 = s.getOutgoings();
              boolean _tripleNotEquals_6 = (_outgoings_8 != null);
              if (_tripleNotEquals_6) {
                {
                  ...
                  for(final Transition st_2 : _outgoings_9) {
                    _builder.append("\t");
                    _builder.append("public void ");
                    String _name_14 = st_2.getAction().getName();
                    ...
                    _builder.append("\t");
                    _builder.append("wrapper.setState(new ");
                    String _name_15 = st_2.getTarget().getName();
                  ...
                  for(final Action a_2 : actions) {
                    {
                      ...
                      boolean _tripleNotEquals_7 = (_outgoings_10 != null);
                      if (_tripleNotEquals_7) {
                        {
                          Transition[] _outgoings_11 = s.getOutgoings();
                          for(final Transition o_2 : _outgoings_11) {
                            {
                              String _name_17 = o_2.getAction().getName();
                              String _name_18 = a_2.getName();
                              boolean _tripleNotEquals_8 = (_name_17 != _name_18);
            ...
            _builder.append(" extends ");
            String _name_21 = s.getZuper().getName();
            _builder.append(_name_21);
            _builder.append("{");
            _builder.newLineIfNotEmpty();
            {
              Transition[] _outgoings_12 = s.getOutgoings();
              boolean _tripleNotEquals_9 = (_outgoings_12 != null);
              if (_tripleNotEquals_9) {
                {
                  ...
                  for(final Transition st_3 : _outgoings_13) {
                    _builder.append("\t");
                    _builder.append("public void ");
                    String _name_22 = st_3.getAction().getName();
                  ...
                  for(final Action a_3 : actions) {
                    {
                      ...
                      boolean _tripleNotEquals_10 = (_outgoings_14 != null);
                      if (_tripleNotEquals_10) {
                        {
                          Transition[] _outgoings_15 = s.getOutgoings();
                          for(final Transition o_3 : _outgoings_15) {
                            {
                              String _name_23 = o_3.getAction().getName();
                              String _name_24 = a_3.getName();
                              boolean _tripleNotEquals_11 = (_name_23 != _name_24);
