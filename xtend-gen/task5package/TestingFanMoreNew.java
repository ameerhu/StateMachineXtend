...
public class TestingFanMoreNew {
	...
	public static void main(String[] args) {
		...
		NamedState loud = new NamedState();
		loud.setName("Loud");
		
		ComplexState silent = new ComplexState();
		silent.setName("Silent");
		StateMachine subsubsubSM = new StateMachine();
		subsubsubSM.setName("SilentMode");
		silent.setStateMachine(subsubsubSM);
		...
		silent.setZuper(low);
		silent.setIsComplex(true);
		loud.setZuper(low);
		loud.setIsComplex(false);
		minLoud.setZuper(silent);
		minLoud.setIsComplex(false);
		maxLoud.setZuper(silent);
		...
		subSubSM.setActions(new Action[] {sMode});
		...
		subSM.setActions(new Action[] {pull,sMode});
